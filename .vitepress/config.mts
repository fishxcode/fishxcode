        ...
        nav: [
          ...
          },
          {
            ...
            items: [
              ...
              { text: 'Codex Desktop', link: '/codex-desktop' },
            ...
            items: [
              {
                items: [
                  ...
                  { text: '计费规则与分组', link: '/billing-groups' },
        ...
        nav: [
          ...
          },
          {
            ...
            items: [
              ...
              { text: 'Codex Desktop', link: '/en/codex-desktop' },
            ...
            items: [
              {
                items: [
                  ...
                  { text: 'Billing & Groups', link: '/en/billing-groups' },
        ...
        nav: [
          ...
          },
          {
            ...
            items: [
              ...
              { text: 'Codex Desktop', link: '/fr/codex-desktop' },
            ...
            items: [
              {
                items: [
                  ...
                  { text: 'Facturation et groupes', link: '/fr/billing-groups' },
        ...
        nav: [
          ...
          },
          {
            ...
            items: [
              ...
              { text: 'Codex Desktop', link: '/es/codex-desktop' },
            ...
            items: [
              {
                items: [
                  ...
                  { text: 'Facturación y grupos', link: '/es/billing-groups' },
        ...
        nav: [
          ...
          },
          {
            ...
            items: [
              ...
              { text: 'Codex Desktop', link: '/pt/codex-desktop' },
            ...
            items: [
              {
                items: [
                  ...
                  { text: 'Cobrança e grupos', link: '/pt/billing-groups' },
